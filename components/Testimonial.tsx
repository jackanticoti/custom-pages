              ...
              <blockquote>
                <div>
                  ...
                  <p className="mt-6 text-2xl font-medium text-white">
                    Receiving my certificate of completion made every all-nighter and the ups and
                    downs of learning well worth the effort.
                  </p>
                </div>
                <footer className="mt-6">
                  <p className="text-base font-medium text-white">Judith Black</p>
                  <p className="text-base font-medium text-indigo-100">Boston, MA</p>
                </footer>
              </blockquote>
            </div>
          </div>
